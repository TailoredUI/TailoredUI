...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="absolute left-1/2 top-4 z-10 w-[90%] -translate-x-1/2 rounded-lg bg-gradient-to-r from-slate-600 to-transparent p-4 backdrop-blur-sm xl:w-[75%]">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="hidden xl:inline-flex">
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="h-8 w-8 cursor-pointer rounded-full bg-gray-800 p-1"
              >
